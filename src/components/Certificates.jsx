...
const CertificateCard = ({ cert, aosDelay }) => (
  <div 
    ...
    className="bg-white/5 backdrop-blur-sm rounded-2xl p-5 border border-white/10 hover:border-red-500/30 hover:bg-white/10 hover:scale-105 hover:shadow-[0_15px_40px_rgba(0,0,0,0.4)] transition-all duration-500 cursor-default group"
  >
...
const Certificates = () => {
  return (
    <section className="bg-[#0a0a0a] pt-24 pb-28 px-6 md:px-12 w-full relative overflow-hidden font-sans">
      
      {/* Torn paper divider at top (transition from red Internships section) */}
